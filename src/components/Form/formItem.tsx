...
export const FormItem: FC<FormItemProps> = (props) => {
  ...
  const rowClass = classNames("easy-row", {
    "easy-row-no-label": !label,
  });
  useEffect(() => {
  ...
  const labelClass = classNames({
    "easy-form-item-required": isRequired,
  });
  const itemClass = classNames("easy-form-item-control", {
    "easy-form-item-has-error": hasError,
  });
  ...
  return (
    <div className={rowClass}>
      {label && (
        <div className="easy-form-item-label">
          <label title={label} className={labelClass}>
            {label}
          </label>
        </div>
      )}
      <div className="easy-form-item">
        <div className={itemClass}>{returnChildNode}</div>
        {hasError && (
          <div className="easy-form-item-explain">
